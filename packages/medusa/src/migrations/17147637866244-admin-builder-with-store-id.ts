...
export class AdminBuilder1714763786624 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "admin_builder" ADD CONSTRAINT "FK_admin_builder_with_store" FOREIGN KEY ("store_id") REFERENCES "store"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )

    await queryRunner.query(
      `CREATE INDEX "IDX_af3ecb6b0333ed80b435c2a0d5" ON "admin_builder" ("property_id") `
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_af3ecb6b0333ed80b435c2a0d5"`
    )
